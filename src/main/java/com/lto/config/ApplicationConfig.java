 ...
 */
@Configuration
@ComponentScan(basePackages = "com.lto",
...
public class ApplicationConfig {
    ...
    static public PropertySourcesPlaceholderConfigurer placeholderConfigurer() throws IOException {
        ...
        resourceLocations.add(resourcePatternResolver.getResource(String.format("file:%s/.gradle/lto.properties", System.getProperty("user.home"))));
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.lto.model");
