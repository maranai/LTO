...
$LTO_ENVIRONMENT = (getenv('ENVIRONMENT')) ? getenv('ENVIRONMENT') : 'development';
define('LTO_ENVIRONMENT', $LTO_ENVIRONMENT);
...
if(LTO_ENVIRONMENT == 'production'){
    Configure::write('debug', 1);
} else if(LTO_ENVIRONMENT == 'qa'){
    Configure::write('debug', 1);
} else {
    Configure::write('debug', 1);
}
...
define('APP_FULL_URL', getAppDomain());
